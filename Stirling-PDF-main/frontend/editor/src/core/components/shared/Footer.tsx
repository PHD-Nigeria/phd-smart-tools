...
export default function Footer({
  ...
  // Default URLs — internal PHD Nigeria policies (update to actual intranet paths)
  const defaultTermsUrl = "/settings/legal";
  const defaultPrivacyUrl = "/settings/legal";
    ...
    >
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://github.com/PHD-Nigeria/phd-smart-tools"
        >
          {t("footer.issues", "Support")}
        </a>
